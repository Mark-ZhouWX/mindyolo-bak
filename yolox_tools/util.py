...
from yolox_tools.transform import xyxy2xywh
...
class EvalWrapper:
    def __init__(self, config , dataset, network, detection_engine, save_prefix: Optional[str] = None) -> None:
        self.logger = config.logger
...
class EvalCallback(Callback):
    def __init__(self, config, eval_wrapper: EvalWrapper):
        self.logger = config.logger
